...
<script src="js/webLoader2.js"></script>
 ...
 <script src="js/lidarCanvas.js"></script>
 <script src="js/fetchObj.js"></script>
 <script>
	window.onload = function () {
		credSet();
		fetchObj('<?php echo $_SESSION["dataPrefix"].$_GET["structure"]."/".$_GET["name"]."obj/" ;?>');
		console.log('<?php echo $_SESSION["dataPrefix"].$_GET["structure"]."/".$_GET["name"] ?>');
